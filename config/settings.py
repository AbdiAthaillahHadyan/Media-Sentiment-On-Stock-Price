...
def parse_float(var, default):
    ...
    # return a float of the variable, if the variable is not a None or an empty string
    if float_var is not None and float_var.strip():
        try:
...
RELEVANCE_THRESHOLD = parse_float("RELEVANCE_THRESHOLD", 0.1)
